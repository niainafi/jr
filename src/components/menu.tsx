  ...
  return (
    <div className="relative flex items-center">
      ...
      <div className="lg:hidden flex items-center">
        ...
        <div className="fixed inset-0 bg-black bg-opacity-80 transition-transform transform translate-x-full peer-checked:translate-x-0 z-[1000]">
          <div className="absolute top-0 right-0 w-64 h-full bg-gray-900 text-white p-6 shadow-lg z-[1000]">
            {/* ✅ Icône de fermeture */}
