  ...
  return (
    <Container className="my-14">
      ...
      >
        {events.map((event, index) => (
          <SwiperSlide key={index}>
            <div className="bg-accent relative px-5 h-auto lg:h-[150px] xl:h-[220px] 2xl:h-[360px] flex lg:flex-row-reverse flex-col">
              {/* Section Image */}
              <div className="relative w-full lg:w-[35%] flex justify-center min-h-full">
                <Image
                  src={event.image}
              ...
              {/* Section Texte */}
              <div className="text-white py-4 lg:mr-5 flex flex-col items-start md:items-start text-center md:text-left w-full lg:w-[73%] min-h-full lg:justify-between">
                <div>
                  <div className="flex flex-col w-full items-start">
                    <p className="text-xs uppercase font-bold pb-1 inline-block">
                      {event.date}
        ...
        {/* Flèches de navigation blanches */}
        <div className="swiper-button-prev2 text-white absolute left-0 top-1/2 transform -translate-y-1/2 z-10">
          <FaChevronLeft size={30} />
        </div>
        <div className="swiper-button-next2 text-white absolute right-0 top-1/2 transform -translate-y-1/2 z-10">
          <FaChevronRight size={30} />
        </div>
      </Swiper>
    </Container>
